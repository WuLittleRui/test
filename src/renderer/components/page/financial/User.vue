    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
              ...
              <el-breadcrumb-item>用户预付款</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
import PaymentDetail from '../charge/PaymentDetail';
import PaymentEdit from '../charge/PaymentEdit';
...
export default {
    ...
    methods: {
        ...
        handleEdit(index, row) {
            this.$refs["PaymentEdit"].showEdit(row.mid);
        },
