    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="list" border class="table" empty-text="没有任何记录" element-loading-text='给我一点时间'
                ...
                <el-table-column prop="name" label="物料名称" header-align="center"  align="center" sortable min-width="120">
                </el-table-column>
                <el-table-column prop="number" label="出库数量" header-align="center"  align="center" sortable min-width="80">
                </el-table-column>
...
export default {
  ...
  data() {
    return {
      multipleSelection: [],
      typeList: [{ name: "采购", value: 1 }, { name: "借用", value: 2 }, { name: "订单", value: 3 }, { name: "报损", value: 4 }],
      /**搜索数据 */
      list: [],
      type:0,
      total: null,
  ...
  methods: {
    ...
    handleDownload() {
      ...
      const tHeader = ['流水号', '物料名称', '出库数量', '出库类型', '出库成本','操作人', '订单流水号', '日志时间']
