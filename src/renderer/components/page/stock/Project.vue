    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
              ...
              <el-breadcrumb-item>库存项目</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
        ...
        <ProjectEdit ref="ProjectEdit" @refresh="getData" />
    </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      this.$refs["ProjectEdit"].showEdit(row.projectId);
    },
