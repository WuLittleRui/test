    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
              ...
              <el-breadcrumb-item>推送消息设置</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :height="tableheight" :data="list" border class="table" empty-text="没有任何记录" element-loading-text='给我一点时间'
                ...
                <el-table-column prop="title" label="标题" header-align="center"  align="center" min-width="120">
                </el-table-column>
                <el-table-column prop="content" label="模板" header-align="center"  align="center" min-width="120">
                </el-table-column>
                <el-table-column prop="type" label="类型" header-align="center"  align="center" min-width="120" :formatter="formatterType">
                </el-table-column>
                <el-table-column prop="status" label="状态" header-align="center"  align="center" min-width="120" :formatter="formatterStatus">
                </el-table-column>
                <el-table-column label="操作"  header-align="center" align="center"  width="200"  v-if="auth.SHOP_ADMIN_DELETE &&  auth.SHOP_ADMIN_EDIT">
        ...
        <SettingEdit ref="SettingEdit" @refresh="getData" />
    </div>
</template>
...
export default {
  ...
  methods: {
    ...
    formatterStatus(row, column, value) {
        if(row.status == 0) {
            return "已通过";
    ...
    handleEdit(index, row) {
      this.$refs["SettingEdit"].showEdit(row.template_id);
    },
    handleDelete(index, row) {
      this.$confirm(
        ...
        HospitalSetting.deleteTemp([row.template_id]).then(res => {
    ...
    delAll() {
      ...
      this.$confirm(
        ...
        await this.multipleSelection.forEach((v, i) => {
          adminIds.push(v.template_id);
        });
        HospitalSetting.deleteTemp(adminIds).then(res => {
          if (res.error === "success") {
            this.$message({
              type: "success",
              message: "删除成功!"
